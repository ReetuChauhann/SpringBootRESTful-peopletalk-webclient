			...
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="addUser" method='post' data-toggle="validator" enctype='multipart/form-data'  class="form-horizontal">
								...
								<!-- <div class="g-recaptcha" data-sitekey="6Ld-Rh4gAAAAABiXCb0vttJtyd7cKs7BIOWAIsdb"></div><br><br> -->
								<div class="form-group">
				...
				<div class="col-lg-6">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="login" method="post" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									<label for="email" class="col-lg-3 control-label">Email:</label>
									<div class="col-lg-9">
										<input type="email" name="email" class="form-control" id="email" placeholder="Enter your email" required />
