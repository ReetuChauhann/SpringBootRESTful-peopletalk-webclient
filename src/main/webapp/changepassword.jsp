			...
			<section>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
						  ...
						  <h1 style="background:orange; color: black; ">Successfully Updated!</h1>
						  </c:if>

						  <c:if test="${status=='failed'}">
						  <h1 style="background:orange; color: black; ">Please Try Again!</h1>
						  </c:if>
							...
							<form action="Changepassword" method="post" data-toggle="validator" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-lg-4">
										<input type="password" name="oldp"class="form-control" id="oldpwd" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="newpwd" class="col-lg-5 control-label">New Password:</label>
									<div class="col-lg-4">
										<input type="password" name="newp" class="form-control" id="newpwd" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
									<label for="confirmpwd" class="col-lg-5 control-label">Confirm Password:</label>
									<div class="col-lg-4">
										<input type="password" name="confp" class="form-control" id="confirmpwd" required/>
									</div>
								</div><!--end form group-->
								<div class="form-group">
